...
import { ItensDetails } from "../pagamento/components/itens"; // Ajuste a importação se necessário
...
export function Page() {
  ...
  return (
    <div>
      <div className="relative flex items-center justify-center p-0 pt-[80px] md:p-4">
        {/* Faixa branca atrás do card principal */}

        {/* Card Principal */}
        <div className="relative mx-auto flex max-w-5xl flex-col bg-cednetWhite shadow-lg md:flex-row md:rounded-[.8rem]">
          {/* Coluna da esquerda */}
